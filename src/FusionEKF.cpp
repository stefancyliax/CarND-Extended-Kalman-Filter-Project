...
FusionEKF::FusionEKF()
{
  ...
  Hj_ = MatrixXd(3, 4);
  // no need to initialize the Jacobian further
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack)
{
  ...
  {
    // Radar updates
    // setup measurement and covariance matrix
    ekf_.R_ = R_radar_;
    ekf_.H_ = tools.CalculateJacobian(ekf_.x_);

    // call extended Kalman filter update for Radar measurements
  ...
  else
  {
    ...
    // call standard Kalman filter update for Lidar measurement
